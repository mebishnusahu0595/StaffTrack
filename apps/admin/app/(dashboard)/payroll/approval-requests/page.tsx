  ...
  return (
    <div className="space-y-8 pb-12 animate-in fade-in duration-300">
      ...
      <div className="flex border-b border-slate-200">
        {[
          { id: "PENDING", label: "Pending", count: data.filter(r => r.status === "PENDING").length || undefined },
          ...
          <div className="flex-1 space-y-2">
            ...
            <Select value={filterType} onValueChange={setFilterType}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Attendance - New Punch Added">Attendance - New Punch Added</SelectItem>
              </SelectContent>
            </Select>
          </div>
